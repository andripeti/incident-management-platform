defmodule IncidentManagementPlatformWeb.UserAuthTest do
  ...
  alias IncidentManagementPlatformWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      ...
      |> Map.replace!(
        :secret_key_base,
        IncidentManagementPlatformWeb.Endpoint.config(:secret_key_base)
      )
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      IncidentManagementPlatformWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        IncidentManagementPlatformWeb.Endpoint.subscribe(
